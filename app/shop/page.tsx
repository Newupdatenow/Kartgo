...
const ALL_PRODUCTS = [
  ...
  },
  {
    ...
    category: "App & Services",
    rating: 4.8,
    description: "Milestone Credit Card - $99 Balance",
    subcategory: "Credit Cards",
  },
  {
    id: "3",
    ...
    category: "App & Services",
    rating: 4.8,
    description: "Milestone Credit Card - $140 Balance",
    subcategory: "Credit Cards",
  },
  {
    id: "4",
  ...
  },
  {
    ...
    category: "App & Services",
    rating: 4.7,
    description: "Capital One Credit Card - $99 Balance",
    subcategory: "Credit Cards",
  },
  {
    id: "6",
    ...
    category: "App & Services",
    rating: 4.7,
    description: "Capital One Credit Card - $140 Balance",
    subcategory: "Credit Cards",
  },
  {
    id: "7",
  ...
  },
  {
    ...
    category: "Finance",
    rating: 4.9,
    description: "Discovery Bank Credit Card - $99 Balance",
    subcategory: "Credit Cards",
  },
  {
    id: "9",
    ...
    category: "Finance",
    rating: 4.9,
    description: "Discovery Bank Credit Card - $140 Balance",
    subcategory: "Credit Cards",
  },
  {
    id: "10",
  ...
  },
  {
    ...
    category: "Finance",
    rating: 4.8,
    description: "Citi Bank Credit Card - $99 Balance",
    subcategory: "Credit Cards",
  },
  {
    id: "12",
    ...
    category: "Finance",
    rating: 4.8,
    description: "Citi Bank Credit Card - $140 Balance",
    subcategory: "Credit Cards",
  },
  {
    id: "13",
    ...
    category: "App & Services",
    rating: 4.6,
    description: "Mercury Credit Card - $60 Balance",
    subcategory: "Credit Cards",
  },
  {
    id: "14",
    ...
    category: "App & Services",
    rating: 4.6,
    description: "Mercury Credit Card - $99 Balance",
    subcategory: "Credit Cards",
  },
  {
    id: "15",
    ...
    category: "App & Services",
    rating: 4.6,
    description: "Mercury Credit Card - $140 Balance",
    subcategory: "Credit Cards",
  },
  ...
  // Bank Logs Section
  {
    ...
    category: "Finance",
    rating: 4.7,
    description: "Arvest Bank Logs - $5k-$15k Balance",
  ...
  },
  {
    ...
    category: "Finance",
    rating: 4.7,
    description: "Arvest Bank Logs - $10k-$20k Balance",
    subcategory: "Bank Logs",
  },
  {
    id: "18",
  ...
  },
  {
    ...
    category: "Finance",
    rating: 4.8,
    description: "Citi Bank Logs - $5k-$15k Balance",
    subcategory: "Bank Logs",
  },
  {
    id: "21",
  ...
  },
  {
    ...
    category: "Finance",
    rating: 4.6,
    description: "Regions Bank Logs - $5k-$15k Balance",
    subcategory: "Bank Logs",
  },
  {
    id: "26",
    ...
    category: "Finance",
    rating: 4.6,
    description: "Regions Bank Logs - $10k-$20k Balance",
    subcategory: "Bank Logs",
  },
  {
    id: "27",
    ...
    category: "Finance",
    rating: 4.6,
    description: "Regions Bank Logs - $20k Balance",
    subcategory: "Bank Logs",
  },
]
